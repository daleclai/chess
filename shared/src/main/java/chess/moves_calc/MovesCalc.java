...
public class MovesCalc {
    ...
    static HashSet<ChessMove> makeStaticMoves(ChessPosition currentPosition, int[][] rel_moves, ChessBoard board) {
        ...
        for (int[] rel_move : rel_moves) {
            ...
            if (board.getPiece(possible_pos) == null || board.getPieceTeam(possible_pos) != color_team) {
    ...
    static HashSet<ChessMove> makeDirection(ChessBoard board, ChessPosition currentPosition, int[][] moveDirections, int current_y, int current_x, ChessGame.TeamColor color_team) {
        ...
        for (int[] direction : moveDirections) {
            ...
            while (!obstructed) {
                ...
                else if (board.getPieceTeam(possiblePosition) != color_team) {
                    moves.add(new ChessMove(currentPosition, possiblePosition, null));
                    obstructed = true;
                }
                else if (board.getPieceTeam(possiblePosition) == color_team) {
